...
const Team = require("../models/Logan-team.js");
 ...
 *     description: Create a new team document.
 ...
 *     responses:
 *       '200':
 *         description: Team documents created.
 *       '500':
 *         description: Server expectations.
 *       '501': 
 *         description: MongoDB expectations.
 */
// route for createTeam method
router.post('/teams', async(req, res) => {
  try {
    // require the data for creating new Team
